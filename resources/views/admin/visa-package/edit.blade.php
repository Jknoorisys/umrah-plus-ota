    ...
    <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-info shadow-info border-radius-lg d-flex justify-content-between align-items-center pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">{{ trans('msg.admin.Edit Visa Package') }}</h6>
            </div>
        </div>
        <div class="card-body">
            <div class="p-4 border rounded">
                <div class="nav-wrapper position-relative end-0">
                    ...
                    <form class="row g-3 needs-validation" action="{{ route('visa-package.edit') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="details-tabs-icons" role="tabpanel" aria-labelledby="details-tab-icons">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea id="process" name="process" rows="4" data-sample="3" data-sample-short>{{ $package->process }}</textarea>
                            ...
                            <div class="tab-pane fade" id="documnets-tabs-icons" role="tabpanel" aria-labelledby="documnets-tab-icons">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea id="documents" name="documents" rows="4" data-sample="3" data-sample-short>{{ $package->documents }}</textarea>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" class="form-control" name="country" id="country" value="{{ $package->country }}" placeholder="{{ trans('msg.admin.Country') }}" required>
                            </div>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" class="form-control" name="processing_time" id="processing_time" value="{{ $package->processing_time }}"  placeholder="{{ trans('msg.admin.Ex 5 to 7 Working days') }}" required>
                            </div>
                            ...
                            <div class="input-group input-group-outline">
                                <select class="select2 form-control" multiple="multiple" style="height: 36px;width: 100%;" name="embassy[]" id="embassy" required>
                                    @forelse ($embassies as $embassy)
                                        <option value="{{ $embassy->id }}" @if(in_array($embassy->id, explode(',', $package->embassy))) selected @endif>{{ $embassy->embassy }}</option>
                                    @empty
                                    @endforelse
                                </select>
                            </div>
