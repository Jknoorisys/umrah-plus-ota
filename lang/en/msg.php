...
return [
    ...
    */
    ...
    'admin' => [
        ...
        'Add/Edit Visa Country' => 'Add/Edit Visa Country',
        ...
        'Select Valid Country' => 'Select Valid Country',
        'Type' => 'Type',
        'Processing Time' => 'Processing Time',
        'Fees' => 'Fees',
        'Enter Visa Type' => 'Enter Visa Type',
        'Enter Valid Processing Time' => 'Enter Valid Processing Time',
        'Ex Upto 5 days' => 'Ex Upto 5 days',
        'Ex 20 days' => 'Ex 20 days',
        'Ex 30 days' => 'Ex 30 days',
        'Stay Period' => 'Stay Period',
        'Enter Valid Stay Period' => 'Enter Valid Stay Period',
        'Validity' => 'Validity',
        'Enter Valid Validity' => 'Enter Valid Validity',
        'Enter Valid Visa Type' => 'Enter Valid Visa Type',
        'Entry Type' => 'Entry Type',
        'Single' => 'Single',
        'Multiple' => 'Multiple',
        'Select Valid Entry Type' => 'Select Valid Entry Type',
        'Currency' => 'Currency',
        'Enter Valid Currency' => 'Enter Valid Currency',
        'Ex INR' => 'Ex INR',
